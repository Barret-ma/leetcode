            ...
            for i in range(len(word)):
                for c in 'abcdefghijklmnopqrstuvwxyz':
                    ...
                    if nextWord != word and nextWord in wordSet:
                        if nextWord not in route:
                            if len(route) + 1 > minLen:
                                break
                            else:
                                if nextWord in pathMap:
                                    if pathMap[nextWord] < len(route):
                                        continue
                                    else:
                                        pathMap[nextWord] = len(route)
                                else:
                                    pathMap[nextWord] = len(route)
                                q.put((nextWord, route + [nextWord]))
        return result
